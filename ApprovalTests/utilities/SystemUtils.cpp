...
namespace ApprovalTests
{
    ...
    std::string SystemUtils::safeGetEnvForWindows(char const* name)
    {
    ...
    std::string SystemUtils::safeGetEnvForNonWindows(char const* name)
    {
        APPROVAL_TESTS_UNUSED(name);
        char* p = nullptr;
#ifndef _WIN32
    ...
    std::string SystemUtils::safeGetEnv(char const* name)
    {
